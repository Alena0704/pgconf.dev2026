...
- AQO needs PG's core hooks. Don't apply patches by hand — clone [Alena0704/postgres@aqo-patched-master](https://github.com/Alena0704/postgres/tree/aqo-patched-master) (the branch already carries the AQO core-hooks patch on top of upstream master) and build from there.
